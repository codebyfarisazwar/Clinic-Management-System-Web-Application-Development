...
<html lang="en">
    <head>
        ...
        <link href="css/tabMedicineP_pharmacy.css" rel="stylesheet">
    ...
    <body>
        ...
        <!-- ======= Hero Section ======= -->
        <section>
            <h3>Payment List by Registration Date Range</h3><br>
            
            <form action="tabMedicineP_pharmacy.jsp" method="get">
        ...
        if (startDateStr != null && endDateStr != null) {
            ...
            try {
                ...
                String query = "SELECT * FROM Payment WHERE payment_Date BETWEEN '" + startDateStr + "' AND '" + endDateStr + "'";
    ...
    %>
            ...
            <table class="table">
                ...
                String pID = rs.getString("payment_IdTreatment"); 
                String pDate = rs.getString("payment_Date"); 
                String pTime = rs.getString("payment_Time"); 
                String pStatus = rs.getString("payment_Status");                     
                String pTotal = rs.getString("payment_TotalPayment");
