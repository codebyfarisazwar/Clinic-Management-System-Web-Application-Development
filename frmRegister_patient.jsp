...
<html lang="en" dir="ltr">
    <head>
        <meta charset="UTF-8">
        <title>Register Patient | Evergreen Clinic</title>
        <link rel="stylesheet" href="css/frmRegister_patient.css">
    ...
    <body>
        <div class="container">
            <div class="title">Register Patient Information</div>
            <div class="content">

                <form name="frmRegister" action="insertRegister_patient.jsp" method="post">
                    ...
                    <div class="user-details">
                        ...
                        <div class="input-box">
                            ...
                            <input type="date" name="registerdate" placeholder="Enter your register date">
                        </div>
                        <div class="input-box">
                        ...
                        <div class="input-box">
                            <span class="details">Allergy To Medicine</span>
