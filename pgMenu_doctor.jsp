...
<html lang="en">
    <head>
        ...
        <link href="css/pgMenu_doctor.css" rel="stylesheet">
        ...
        <header id="header" class="fixed-top  header-transparent ">
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <nav id="navbar" class="navbar">
                    <ul>
                        <li><a class="nav-link scrollto" href="updProfile_doctor.jsp">Profile</a></li>
        ...
        <section>
            ...
            <div class="container">
                ...
                <div class="content">
                    ...
                    <a href="frmTreatment_doctor.jsp" class="btn">dispense <i class="bx bx-home-heart"></i></a>
                    <a href="tabReport_doctor.jsp" class="btn">report <i class="bx bx-task"></i></a>
