...
<html lang="en" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" href="css/frmRegister_cleark.css">
    ...
    <body>
        <div class="container">
            <div class="title">Register Cleark New Account</div>
            <div class="content">

                <form name="frmRegister" action="insertRegister_cleark.jsp" method="post">
