...
<html>
    <head>
        ...
        <title>Insert Pharmacy Data Into Database</title>
    </head>
    <body>
        ...
        <%           
            ...
            try {
                ...
                String sqlInsertPharmacy = "INSERT INTO Employee" + "(employee_IC, employee_Name, employee_Address, employee_PhoneNumber, employee_Position, employee_DateOfBirth, employee_Gender, employee_loginID)"
                        + "VALUES" + "('"+icnumber+"', '"+fullname+"', '"+address+"' , '"+phonenumber+"' , 'P' , '"+birthdate+"' , '"+gender+"' , '"+loginid+"')";

                //execute sqlInsertPharmacy
                int rowPharmacy = stmtSQLpharmacy.executeUpdate(sqlInsertPharmacy);

                if (rowPharmacy > 0) {
                    out.println("<br>Pharmacy successfully inserted into table Login" + "table Employee");
                    ...
                    out.println("<br>Pharmacy fail inserted into table Employee");
                }
                ...
                if (stmtSQLpharmacy != null) {
                    stmtSQLpharmacy.close();
                }
                if (connection != null) {
                    connection.close();
                }
