...
<html lang="en" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" href="css/frmRegister_pharmacy.css">
    ...
    <body>
        <div class="container">
            <div class="title">Register Pharmacy New Account</div>
            <div class="content">
                
                <form name="frmRegister" action="insertRegister_pharmacy.jsp" method="post">
