...
<html>
    <head>
        ...
        <title>Insert Doctor Data Into Database</title>
    </head>
    <body>
        ...
        <%           
            ...
            try {
                ...
                String sqlInsertDoctor = "INSERT INTO Employee" + "(employee_IC, employee_Name, employee_Address, employee_PhoneNumber, employee_Position, employee_DateOfBirth, employee_Gender, employee_loginID)"
                        + "VALUES" + "('"+icnumber+"', '"+fullname+"', '"+address+"' , '"+phonenumber+"' , 'D' , '"+birthdate+"' , '"+gender+"' , '"+loginid+"')";

                //execute sqlInsertDoctor
                int rowDoctor = stmtSQLdoctor.executeUpdate(sqlInsertDoctor);

                if (rowDoctor > 0) {
                    out.println("<br>Doctor successfully inserted into table Login" + "table Employee");
                    ...
                    out.println("<br>Doctor fail inserted into table Employee");
                }
