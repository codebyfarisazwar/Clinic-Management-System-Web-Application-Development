...
<%
    ...
    try {
        ...
        if (resultEmployee > 0 && resultLogin > 0) {
            out.println("<script>alert('Update profile and password successful'); window.location.href='pgMenu_cleark.jsp';</script>");
        } else {
            out.println("<script>alert('Failed to update'); window.location.href='updProfile_cleark.jsp';</script>");
        }
